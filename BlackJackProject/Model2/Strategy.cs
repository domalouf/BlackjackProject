...
namespace BlackJack
{
    ...
    public class Strategy
    {
        ...
        public char GetMove(int card1, int card2, int dcard)
        {
            ...
            {
                if (card1 == 11)
                    return stotals[card2, dcard];
                else
                    return stotals[card1, dcard];
            }
            return htotals[card1 + card2, dcard];
        }
        ...
        public Strategy()
        {
            ...
            try
            {
                ...
                using (StreamReader sr = new StreamReader(@"..\..\..\Resources\BasicStrategyChart.txt"))
                {
                    for (int i = 0; i < 3; i++)
                    {
                        //hard totals
